const language = {
    "en": {
        "login": "Login 🔑",
        "registration": "Register ®️",
        "welcomeMessage": 
        `#MahBet\nA Different Experience\n\n⚡️⚡️First Time in Iran⚡️⚡️\n\n🔥🔥Welcome to MahBet Telegram Casino🔥🔥\n\n👌 Play on MahBet without VPN 👌\n📌 Instant bet settlement\n📌 Safe deposit and withdrawal\n📌 Support for all sports\n♣️ Most complete international live casino\n♣️ Most diverse slot machine games with unlimited wins\n♦️ Guaranteed security for high-value wins\n♠️ Professional support\n🔼💰🔽 Deposit and withdrawal in Rial, Perfect Money and Crypto\n\n👇 Enter the site now and enjoy 👇`,
        "welcomeButtonInline": "📌 MahBet Website",
        "welcomeButtonKeyboard": "Open Website 📌",
        "forMoreMessage": "For bonuses and support, use the menu below 👇",
        "suppotButtonKeyboard": "Live Support 🗣️",
        ...
        "getLinkButtonKeyboard": "Get link 🔗",
        "getLinkButtonMiniApp": "🚀 Open in Telegram",
        "getLinkButtonBrowser": "🌐 Open in browser",
        "getLinkMessage": "Open MahBet — inside Telegram, or in your browser 👇",
        "noLinkMessage": "No link is available right now. Please try again later.",
    ...
    "fa": {
        ...
        "getLinkButtonKeyboard": "دریافت لینک 🔗",
        "getLinkButtonMiniApp": "🚀 باز کردن در تلگرام",
        "getLinkButtonBrowser": "🌐 باز کردن در مرورگر",
        "getLinkMessage": "ورود به ماه بت — داخل تلگرام یا در مرورگر 👇",
        "noLinkMessage": "در حال حاضر لینکی در دسترس نیست. لطفاً بعداً دوباره تلاش کنید.",
